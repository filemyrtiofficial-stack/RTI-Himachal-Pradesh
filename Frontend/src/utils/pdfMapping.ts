...
const detectState = (departmentName: string): string => {
  // Check for Himachal Pradesh in department name
  if (departmentName.toLowerCase().includes('himachal')) {
    return 'himachal-pradesh';
  }
  // Default to current state (Himachal Pradesh)
  return 'himachal-pradesh';
};
...
const departmentToPDFMap: PDFMapping = {
  ...
  // All Himachal Pradesh PDFs are in: /assets/PDF/RTI_Jammu_and_Kashmir_FULL_CERTIFIED_FINAL/
  // Organized in subfolders by category
  

  // ========== HIMACHAL PRADESH DEPARTMENTS ==========
  // All Himachal Pradesh PDFs are in: /assets/PDF/
  'RTI Himachal Pradesh Agriculture Department': 'RTI_Himachal_Pradesh_Agriculture_Department.pdf',
  'RTI Himachal Pradesh Animal Husbandry Department': 'RTI_Himachal_Pradesh_Animal_Husbandry_Department.pdf',
  'RTI Himachal Pradesh Education Department': 'RTI_Himachal_Pradesh_Education_Department.pdf',
  'RTI Himachal Pradesh Election Department': 'RTI_Himachal_Pradesh_Election_Department.pdf',
  'RTI Himachal Pradesh Energy Department': 'RTI_Himachal_Pradesh_Energy_Department.pdf',
  'RTI Himachal Pradesh Excise & Taxation Department': 'RTI_Himachal_Pradesh_Excise_&_Taxation_Department.pdf',
  'RTI Himachal Pradesh Finance Department': 'RTI_Himachal_Pradesh_Finance_Department.pdf',
  'RTI Himachal Pradesh Forest Department': 'RTI_Himachal_Pradesh_Forest_Department.pdf',
  'RTI Himachal Pradesh General Administration Department': 'RTI_Himachal_Pradesh_General_Administration_Department.pdf',
  'RTI Himachal Pradesh Health & Family Welfare Department': 'RTI_Himachal_Pradesh_Health_&_Family_Welfare_Department.pdf',
  'RTI Himachal Pradesh Higher Education Department': 'RTI_Himachal_Pradesh_Higher_Education_Department.pdf',
  'RTI Himachal Pradesh Home Department': 'RTI_Himachal_Pradesh_Home_Department.pdf',
  'RTI Himachal Pradesh Horticulture Department': 'RTI_Himachal_Pradesh_Horticulture_Department.pdf',
  'RTI Himachal Pradesh Industries Department': 'RTI_Himachal_Pradesh_Industries_Department.pdf',
  'RTI Himachal Pradesh Information & Public Relations Department': 'RTI_Himachal_Pradesh_Information_&_Public_Relations_Department.pdf',
  'RTI Himachal Pradesh Information Technology Department': 'RTI_Himachal_Pradesh_Information_Technology_Department.pdf',
  'RTI Himachal Pradesh Irrigation & Public Health Department': 'RTI_Himachal_Pradesh_Irrigation_&_Public_Health_Department.pdf',
  'RTI Himachal Pradesh Labour & Employment Department': 'RTI_Himachal_Pradesh_Labour_&_Employment_Department.pdf',
  'RTI Himachal Pradesh Law Department': 'RTI_Himachal_Pradesh_Law_Department.pdf',
  'RTI Himachal Pradesh Planning Department': 'RTI_Himachal_Pradesh_Planning_Department.pdf',
  'RTI Himachal Pradesh Police Department': 'RTI_Himachal_Pradesh_Police_Department.pdf',
  'RTI Himachal Pradesh Public Works Department': 'RTI_Himachal_Pradesh_Public_Works_Department.pdf',
  'RTI Himachal Pradesh Registration & Stamps Department': 'RTI_Himachal_Pradesh_Registration_&_Stamps_Department.pdf',
  'RTI Himachal Pradesh Revenue Department': 'RTI_Himachal_Pradesh_Revenue_Department.pdf',
  'RTI Himachal Pradesh Rural Development & Panchayati Raj Department': 'RTI_Himachal_Pradesh_Rural_Development_&_Panchayati_Raj_Department.pdf',
  'RTI Himachal Pradesh Social Justice & Empowerment Department': 'RTI_Himachal_Pradesh_Social_Justice_&_Empowerment_Department.pdf',
  'RTI Himachal Pradesh Technical Education Department': 'RTI_Himachal_Pradesh_Technical_Education_Department.pdf',
  'RTI Himachal Pradesh Tourism Department': 'RTI_Himachal_Pradesh_Tourism_Department.pdf',
  'RTI Himachal Pradesh Transport Department': 'RTI_Himachal_Pradesh_Transport_Department.pdf',
  'RTI Himachal Pradesh Tribal Development Department': 'RTI_Himachal_Pradesh_Tribal_Development_Department.pdf',
 ...
 * @returns The state name ('telangana', 'himachal-pradesh', or 'delhi')
 */
