/**
 * ============================================================================
 * HOMEPAGE - Himachal Pradesh-SPECIFIC
 * ============================================================================
 * 
 * Purpose: Main landing page for the RTI platform, specifically configured
 *          for Himachal Pradesh state.
 * 
 * State Usage: Himachal Pradesh (active) - This is the primary homepage
 * 
 * Key Features:
 * - Hardcoded to use Himachal Pradesh state data
 * - Uses lazy-loaded Himachal Pradesh-specific components
 ...
 * 
 * Used by: Himachal Pradesh (homepage route "/")
 * ============================================================================
 */
...
// ====== Himachal Pradesh-SPECIFIC COMPONENTS (Lazy Loaded) ======
// All Himachal Pradesh components are state-specific and used only on homepage
...
export const Home: React.FC = () => {
  ...
  // Homepage is hardcoded to Himachal Pradesh state
  const { stateData, isLoading } = useStateData('himachal-pradesh');
  ...
  // ====== SEO METADATA ======
  const pageTitle = `File RTI Online in Himachal Pradesh - FileMyRTI`;
  const pageDescription = `File RTI online in Himachal Pradesh with FileMyRTI. Get expert-drafted RTI applications and appeals for Himachal Pradesh Government departments, Secretariat and district offices from home.`;
  ...
  const faqStructuredData = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is RTI and who can file it?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "RTI (Right to Information) is a fundamental right under the RTI Act 2005 that allows any Indian citizen to request information from public authorities. You can file RTI applications to seek information about government activities, decisions, public expenditure, and services provided by Himachal Pradesh government departments."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "As per the RTI Act, the concerned Public Information Officer (PIO) must provide information within 30 days from the date of receipt."
        }
      },
      {
        "@type": "Question",
        "name": "Do I need to visit any government office to file RTI?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "No. The RTI filing process can be completed fully online with assistance from FileMyRTI. We handle all the paperwork, submission, and fee payment for you without requiring you to visit any government office."
        }
      },
      {
        "@type": "Question",
        "name": "Which Himachal Pradesh departments can I file RTI applications for?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "You can file RTI applications for all Himachal Pradesh Government departments including General Administration, Home, Finance, Revenue, School Education, Higher Education, Health & Medical Education, Public Works (R&B), Power Development, Jal Shakti, Agriculture, Forest & Environment, Industries & Commerce, Tourism, Housing & Urban Development, Rural Development & Panchayati Raj, Social Welfare, Labour & Employment, Transport, and many more."
        }
      },
      {
        "@type": "Question",
        "name": "What documents do I need to file an RTI?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "For filing an RTI in Himachal Pradesh, you primarily need to clearly describe the information you're seeking. No identity proof is mandatory for filing, but having Aadhaar or voter ID helps for communication purposes. For BPL fee exemption, you'll need your BPL card."
        }
      },
      {
        "@type": "Question",
        "name": "Can I file RTI anonymously?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, we offer anonymous RTI filing services for Himachal Pradesh departments where your identity is protected throughout the process. Our team files the application on behalf of our organization, ensuring your privacy while exercising your right to information."
        }
      }
    ]
  };
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        <main id="main-content" className="flex-grow" role="main" aria-label="Main content" style={{ paddingTop: 0 }}>
            ...
            <div className="bg-primary-600 pt-12 pb-12" data-loading>
              <div className="container-responsive max-w-7xl mx-auto px-4">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 leading-tight">
                  File RTI Online for Himachal Pradesh Government Departments
                </h1>
              </div>
            </div>
          }>
          ...
          {/* 13. List of Himachal Pradesh government departments supported */}
          <Suspense fallback={<div className="min-h-[400px]" />}>
            <RajasthanDepartmentsCoveredSection />
          </Suspense>

          {/* 9. RTI Templates for Himachal Pradesh (letter templates/resources) */}
          <Suspense fallback={<div className="min-h-[400px]" />}>
