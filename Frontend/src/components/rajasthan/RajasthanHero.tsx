...
export const RajasthanHero: React.FC<RajasthanHeroProps> = () => {
  ...
  return (
    <section className="relative overflow-hidden min-h-[90vh] flex items-center" style={{ backgroundColor: '#1a2332', marginTop: 0, paddingTop: '64px' }}>
      {/* State Background Image - Positioned to show landscape prominently on left */}
      <div 
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#1a2332]/20 via-[#1a2332]/40 to-[#1a2332]/60"></div>
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-8 inline-flex items-center">
              <div className="bg-transparent border-2 border-gray-400 rounded-lg px-6 py-3 inline-flex items-center gap-3">
                ...
                <p className="text-sm md:text-base text-white font-medium">
                  RTI Filing Service for Himachal Pradesh
                </p>
              </div>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection animation="slideUp" delay={300}>
            <h1 className="mb-6 text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-white">
              File RTI Online in <span style={{ color: '#CFE4F7', fontWeight: 800, letterSpacing: '0.5px' }}>Himachal Pradesh</span>
            </h1>
          </AnimatedSection>
          ...
          <AnimatedSection animation="slideUp" delay={400}>
            <p className="text-lg md:text-xl text-white mb-10 max-w-3xl mx-auto leading-relaxed">
              Exercise your constitutional right to information. File RTI applications for any Himachal Pradesh Government department with our trusted, legal assistance.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection animation="fadeIn" delay={700}>
            <p className="text-white/80 text-base md:text-lg mb-8">
              Trusted by citizens across Himachal Pradesh
            </p>
          </AnimatedSection>
