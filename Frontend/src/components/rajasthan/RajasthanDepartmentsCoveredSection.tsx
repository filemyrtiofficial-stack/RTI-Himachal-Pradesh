      ...
      <div className="container-responsive max-w-7xl mx-auto px-4">
        <AnimatedSection animation="fadeIn" delay={200}>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif font-semibold text-gray-900 tracking-wide mb-6">Himachal Pradesh Departments Covered</h2>
            <p className="text-base md:text-lg font-normal text-gray-600 max-w-2xl mx-auto leading-relaxed">
              We handle RTI applications across all Himachal Pradesh government departments with state-specific expertise.
            </p>
          </div>
        </AnimatedSection>
