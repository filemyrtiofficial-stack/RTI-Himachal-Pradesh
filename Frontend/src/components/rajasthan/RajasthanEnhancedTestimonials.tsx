...
const testimonials = [
  {
    quote: "I needed confirmation regarding the status of my hotel license application. FileMyRTI ensured the RTI was filed correctly. The official reply clarified my doubts.",
    name: "Rohit Thakur",
    location: "Himachal Pradesh",
    role: "Tourism Operator",
    image: "/images/Rohit Thakur.webp"
  },
  {
    quote: "I was seeking clarification related to my service records. FileMyRTI helped structure the RTI request properly. The department provided accurate information.",
    name: "Meena Sharma",
    location: "Himachal Pradesh",
    role: "Clerk",
    image: "/images/Meena Sharma.webp"
  },
  {
    quote: "I needed evaluation-related details from my university authorities. FileMyRTI made the RTI process simple. The response was received within the expected time.",
    name: "Nitin Verma",
    location: "Himachal Pradesh",
    role: "Student",
    image: "/images/Nitin Verma.webp"
  }
];
        ...
        <AnimatedSection animation="fadeIn" delay={200}>
          <div className="text-center mb-12">
            ...
            <p className="text-base md:text-lg font-normal text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Thousands of Himachal Pradesh citizens have successfully obtained government 
